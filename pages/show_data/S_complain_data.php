...
<body id="top" >
  ...
  <div class="bgded overlay" style="background-image:url('../../images/PBackground.jpg');">
    ...
    <div class="wrapper row1">
      ...
      <!-- ################################################################################################ -->
      <h2 style=" text-align: center; padding:25px;">Complain</h2>
      <!-- ################################################################################################ -->
      <!-- ################################################################################################ -->
      <div class=""style="padding: 25px;">
        <table border="1" style="color: black;">
          ...
          <tr>
            ...
            $s = "select name,address, mobile_no, email, suggestions from complain";
            $result = mysqli_query($conn,$s);
            $num = mysqli_num_rows($result);
            if ($num >0) {
              while ($row = mysqli_fetch_assoc($result) ) {
                echo "<tr><td>".$row["name"]."</td><td>".$row["address"]."</td><td>".$row["mobile_no"]."</td><td>".$row["email"]."</td><td>".$row["suggestions"]."</td></tr>";
              }
            }
