  ...
  <div class="bgded overlay" style="background-image:url('../images/form_backround4.jpg'); height: 250px">
    ...
    <div class="wrapper row3" style="background-color: #04070d;">
      <main class="hoc container clear">
        <!-- main body -->
        <!-- ################################################################################################ -->
        <form style="margin-top: -150px;" action="includes/Buy Machineries_data.php" method="post">
          <table style="padding:20px; table-layout: center;">
            ...
            <tr>
              <td>
                <label for="m_code">মেশিনের কোড নং : </label>
              </td>
              <td>
                <input type="text" class="form-control" size="35" name="m_code">
              </td>
            </tr>
            <br>
            <tr>
