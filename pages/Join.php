...
<html lang="">
<head>
  <title>Agrofarming || Join Page</title>
  <meta charset="utf-8">
...
<body id="top" >
  ...
  <div class="bgded overlay" style="background-image:url('../images/form_backround.jpg'); height: 250px">
    ...
    <div class="wrapper row1">
      ...
      <!-- ################################################################################################ -->
      <!-- ################################################################################################ -->
      <h2 style=" text-align: center; padding:25px;">Sign In Page</h2>
      <!-- ################################################################################################ -->
    </div>
      ...
      <main class="hoc container clear">
        ...
        <form action="includes/validation.php" method="post" >
          <div class="container" style="padding: 25px">
            ...
            <button type="submit" class="btn btn-primary" style="border-radius: 10px;">Sign In</button><br>
            <p>If you are not registered please <a href="registration.php">Sign up!!</a></p>
          </div>
        </form>
        <br>
